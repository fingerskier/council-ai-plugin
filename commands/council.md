---
description: Convene a council and put it to work — convene | meeting | work
argument-hint: convene [template] | meeting "<task>" | work "<task>"
...
If the verb is missing or unrecognized, briefly list the three verbs above and
stop.

Now **follow the `council-orchestrator` skill** to carry out that verb. The
skill contains the full procedure for `convene`, `meeting`, and `work`,
